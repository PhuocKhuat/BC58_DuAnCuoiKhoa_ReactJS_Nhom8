      ...
      <div className="container px-5 py-20 mx-auto">
        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded xs:flex block p-4 h-full items-center frameContainerLogo">
          ...
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded xs:flex block p-4 h-full items-center frameContainerLogo">
              ...
              <p className="title-font font-medium">
                Master and practice coding techniques, analytical and
          ...
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded xs:flex block p-4 h-full items-center frameContainerLogo">
              ...
              <p className="title-font font-medium">
                Understand and master the necessary skills related to the
                Fullstack Programming profession
              </p>
            </div>
          </div>
        </div>
