...
export default function CourseOutputs() {
  return (
    <div className="text-gray-600 body-font py-24 coursesOutput">
      ...
      <div className="block lg:flex space-x-5">
        ...
        <div className="divImgCertificate object-cover mt-10">
          <img alt="" src="/img/certificate.jpg" className="object-cover imgCertificate"/>
        </div>
      </div>
      </div>
    </div>
